    ...
    <div className="container">
        <div className='row g-3'>
            <div className='col-lg-2 ' >
                <div>
                    ...
                    <div className={style} >
                        ...
                        <button className='btn btn-light  mt-4 w-100'>Buy Something</button>
                        <button className='btn btn-light  mt-4 w-100'>Deliver Something</button>
            ...
            <div className='col-lg-9 offset-lg-1 ' >
                ...
                <br />
               <div >
               <Link to="/work"> <button className=' className=" btn btn-light offset-lg-4 mb-4  w-50 "'>Do You Want To Work With Us  </button></Link>
               </div>
